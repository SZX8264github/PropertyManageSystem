    ...
    <el-card class="card-list" shadow="never">
      ...
      >
        ...
        <el-table-column
          ...
          width="200px"
        ></el-table-column>
        <el-table-column label="管理员头像" width="145px">
        ...
        <el-table-column
          ...
          width="200px"
        ></el-table-column>
        <el-table-column label="管理员性别" width="100px">
          <template #default="scope">
            <div>
...
const getUserList = async () => {
  const response = await axiosPostRequest("/user/list", {
    ...
    param: {
      id: dataList.loginUser.roleId === 3 ? dataList.loginUser.id : "",
