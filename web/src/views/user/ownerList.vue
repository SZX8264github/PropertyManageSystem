    ...
    <el-card class="card-list" shadow="never">
      ...
      >
        ...
        <el-table-column
          ...
          width="200px"
        ></el-table-column>
        <el-table-column label="业主头像" width="145px">
        ...
        <el-table-column
          ...
          width="200px"
        ></el-table-column>
        <el-table-column label="业主性别" width="100px">
          <template #default="scope">
            <div>
      ...
      <template #content>
        <el-form :model="dataList.userForm" label-width="100px">
          ...
          <el-form-item label="职位">
            <el-input
              v-model="dataList.userForm.position"
              placeholder="请输入职位"
            ></el-input>
          </el-form-item>
          <el-form-item label="学历">
            <el-input
              v-model="dataList.userForm.study"
              placeholder="请输入学历"
            ></el-input>
          </el-form-item>
